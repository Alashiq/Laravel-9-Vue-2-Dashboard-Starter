...
export default {
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$loading.Start();
            this.$http
                .GetAllxmodels(this.pageId, this.countPerPage
                    //Parxcolumn
                )
                .then(response => {
                    this.$loading.Stop();
        ...
        deleteMainItem: function (id) {
            Swal.fire({
                title: "هل أنت متأكد",
                text: "هل أنت متأكد من أنك تريد حذف هذا الxsingleArabic !",
                icon: "warning",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا الxsingleArabic متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
